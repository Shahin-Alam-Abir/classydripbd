        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-8">
              ...
              <a href="https://instagram.com/menslifestylebd" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-700 flex items-center justify-center hover:bg-white hover:text-black hover:border-white transition" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@Mens_Lifestyle_bd" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-700 flex items-center justify-center hover:bg-white hover:text-black hover:border-white transition" aria-label="YouTube">
              ...
              <a href="https://t.me/menslifestylebd" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-700 flex items-center justify-center hover:bg-white hover:text-black hover:border-white transition" aria-label="Telegram">
